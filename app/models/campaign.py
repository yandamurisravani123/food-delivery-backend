...
class Campaign(Base):
    ...
    campaign_type = Column(PgEnum(CampaignType, name="campaign_type_enum"), nullable=False)
    status = Column(PgEnum(CampaignStatus, name="campaign_status_enum"), default=CampaignStatus.SCHEDULED)
...
class OfferControl(Base):
    ...
    minimum_discount = Column(Float, default=0)
