...
from app.api.v1.customer.order_tracking import router as order_tracking_router
from app.api.v1.customer.delivery_notification_router import router as delivery_notification_router
from app.api.v1.customer.payment_method import router as payment_method_router
from app.api.v1.customer.rating_router import router as rating_router
from app.api.v1.customer.order_preparation_router import router as preparation_router
from app.api.v1.customer.savings_router import router as savings_router
from app.api.v1.customer.recommendation_router import router as ai_recommendation_router
